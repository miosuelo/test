...
if ($u->getJerarquia() > 2) {
    ...
    <div class="container-fluid">
        ...
        <form action="" method="POST" id="AgregarV">
            <table class="table table-primary table-responsive table-bordered mt-2">
                ...
                <tr>
                    ...
                    <td><input type="text" maxlength="12" class="form-control" id="Patente" required></td>
        ...
        <table id="vehicleTable" class="table table-striped table-responsive table-bordered">
            <thead class="table-dark">
            <tr>
                <th scope="col">ID</th>
                <th scope="col">Tipo</th>
