...
select a_articulo, f_id,u_nombre,f_date,s_patente,s_tipo,v_tipo,v_patente
        ...
        while (($res = mysqli_fetch_assoc($busqueda)) != null) {
            ...
            <div class="card shadow  text-dark bg-light col-sm-4  mx-3 my-2">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">El DÍA <?php echo $res['f_date'] ?>.</p>
                    <p class="card-text">PATENTE: <?php echo $res["s_patente"]  ?> </p>
                    <p class="card-text">TIPO: <?php echo $res["s_tipo"] ?></p>
                    <p class="card-text">CON EL VEHICULO PATENTE: <?php echo " " . $res["v_patente"] . " DE TIPO: ".$res["v_tipo"] ?></p>
                        ...
                        <div class=" modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-dark">
                                    <h5 class="modal-title fw-bold text-white " id="exampleModalLabel"><?php echo "Check List de " . $res['a_articulo'] ?></h5>
                                    <button class="btn btn-info ms-auto" onclick="gene('exampleBodyModal<?php echo $contador ?>','<?php echo $res['u_nombre'] ?>','<?php echo $res['f_date'] ?>','<?php echo $res["s_patente"]  ?>' , ' <?php echo $res["v_patente"]  ?>' ,'<?php echo $res['a_articulo'] ?>')" id="cmd">Generar PDF</button>
